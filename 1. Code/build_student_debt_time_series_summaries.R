...
write_csv(sipp_black_nonblack, file.path(paths$sipp_csv_dir, "sipp_student_debt_time_series_black_nonblack.csv"), na = "")
...
cat("Wrote:", file.path(paths$sipp_csv_dir, "sipp_student_debt_time_series_black_nonblack.csv"), "\n")
